...
Documentation repository for the AI context file maturity model.
...
Key paths:
- @maturity-model.md — Level definitions and assessment
...
- NEVER duplicate level definitions — reference @maturity-model.md instead
