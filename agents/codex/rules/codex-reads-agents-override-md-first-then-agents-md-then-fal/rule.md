...
checks:
- id: CODEX.S.0001.file_in_scope
  type: mechanical
  severity: medium
  name: file_in_scope
  check: file_exists
- id: CODEX.S.0001.discovery_chain_documented
  type: deterministic
  severity: medium
...
Codex AGENTS.md discovery SHOULD follow the override-then-fallback chain per directory
