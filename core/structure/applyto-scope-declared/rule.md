...
checks:
- id: CORE.S.0015.instruction_file_exists
  type: mechanical
  severity: high
  name: instruction_file_exists
  check: file_exists
- id: CORE.S.0015.has_applyto_frontmatter
  type: deterministic
  severity: high
...
Scoped instruction files MUST use applyTo frontmatter to declare their target file patterns
